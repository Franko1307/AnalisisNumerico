...
$('#ordenar').click(function()
{
	try{
		...
		if ( esDominante(arr) ) {
			...
			var contador = 0
			do{
				procedimientoJacobbi(vectorRespuesta,auxRespuesta,copia1)
...
function procedimientoJacobbi (vectorRespuesta, vectorAnterior, matriz) 
{
	...
	for (var x in vectorRespuesta){
		...
		for (var i = 0; i < x; ++i) vectorRespuesta[x] -= redondear (  vectorAnterior[i]*matriz[x][i],nr)
